...
def main():
	...
	for i in range(max_questions):
		...
		while flag == 0:	
			...
			m = random.randrange(10,63)
			n = random.randrange(2,68-m)
			l = random.randint(0,8)
			#print j,k,m,n,l
			qnum = random.choice([0,1,2,3,4,5,6,7,8])
...
def generatequestion(j,k,m,n,l,qnum,h_s,z):
	if m%10 == n%10:		
		...
		print z
		builder.save("./output/G2_007", "G2_007-"+str(z))
