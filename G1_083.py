...
for hours in range(1,13):
	...
	for minutes in [0,6]:
		...
		builder.clock(int(hours),int(minutes),size = HUGE_PICTURE_SIZE,center=True)
		...
		checkbox_data_1.text(hours+":"+minutes)
		#print(m+n)
		...
		counter = counter+1
		builder.save("./output/G1_083", "G1_083-"+str(counter))
